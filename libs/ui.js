...
ui.prototype._drawBook_drawOne = function (
    floorId,
    index,
    enemy,
    pageinfo,
...
ui.prototype._drawBook_is32x32 = function (blockInfo) {
    ...
    core.drawImage(
        ...
        blockInfo.image,
        0,
        blockInfo.posY * blockInfo.height,
        32,
        height,
        0,
        0,
...
ui.prototype._drawBook_drawRow2 = function (
    ...
    if (core.flags.statusBarItems.indexOf("enableMoney") >= 0)
        second_line.push([
            core.getStatusLabel("money"),
            core.formatBigNumber(enemy.money || 0),
        ]);
    if (core.flags.enableAddPoint)
        second_line.push([
            core.getStatusLabel("point"),
            core.formatBigNumber(enemy.point || 0),
        ]);
    if (core.flags.statusBarItems.indexOf("enableExp") >= 0)
        second_line.push([
            core.getStatusLabel("exp"),
            core.formatBigNumber(enemy.exp || 0),
        ]);
...
ui.prototype._drawViewMaps_drawHint = function () {
    ...
    stroke(perpx, perpy, 3 * perpx, perpy);
    stroke(perpx, 3 * perpy, 3 * perpx, perpy);
    stroke(0, 0, cornerpx, cornerpy);
    stroke(core._PX_ - cornerpx, 0, cornerpx, cornerpy);
    stroke(0, core._PY_ - cornerpy, cornerpx, cornerpy);
...
ui.prototype._drawSLPanel_drawRecords = function (n) {
    ...
    for (var i = 0; i < (n || 6); i++) {
        ...
        var yTop1 = topSpan + parseInt(charSize / 2) + 8;
