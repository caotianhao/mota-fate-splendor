var data_a1e2fb4a_e986_4524_b0da_9b7ba7c0874d = 
{
	...
	"firstData": {
		...
		"startText": [
			...
			"他的利剑穿透了我的胸膛。",
			"这具充溢着罪恶的身躯终于化为了尘土。",
			"他的眼神跟我很像，怯懦中带着些许虚伪的坚定。",
			"他跟曾经的我一样迷茫。",
			"因为一无所有，才一往无前。",
			"就连握剑的姿势也跟曾经的我一模一样。",
			"曾经的勇者败在另一位勇者的剑下，这个结局倒也不坏。",
			"她在流泪吗？我不明白。",
			"万恶的魔王被斩灭，和平终于重新降临在这片土地上。",
			"这明明是皆大欢喜的结局。",
			"没用的，我的身体已经形如一滩死灰，我已经再也没有办法感受你怀里的温度了。",
			"她想干什么？",
			"从那么高的地方摔下去的话，以普通人类的脆弱身体，毫无疑问会丧命的。",
			{
				"type": "sleep",
				"time": 500
			},
