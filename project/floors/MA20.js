main.floors.MA20=
{
    ...
    "afterGetItem": {
        "2,8": [
            ...
            "\t[公主,princess]\b[up,null]你是谁？谁让你进来的？",
            "\t[勇士,hero]\b[up,null]我是王国护卫队的人，是奉上头的指令来抓你回去参加宫廷舞会的。",
            "\t[勇士,hero]\b[up,null]公主大人，跟我走吧，你父王还有邻国的各位王子都在等你。",
            "\t[公主,princess]\b[up,null]什么时候黑铁级勇士都能加入护卫队了？噗嗤，看来他们的招人标准越放越低了啊。",
            "\t[勇士,hero]\b[up,null]......公主大人，不要转移话题，你的父王非常生气，我劝你还是不要反抗为好。",
            "\t[公主,princess]\b[up,null]好了好了，别装作一副那么严肃的凶样嘛，你满脸通红，吐字带颤音，甚至都不敢正视我的眼睛。",
            "\t[公主,princess]\b[up,null]你是不是看上我了？也难怪，我对自己的容貌还是相当有自信的。",
            "\t[公主,princess]\b[up,null]呵呵，毕竟我可是父王他们费尽心思精心装点的政治礼物啊。",
            "\t[勇士,hero]\b[up,null].....公主大人，请跟我走吧。",
            "\t[公主,princess]\b[up,null]别催了，我并没有拒接你的请求，我只是想多在我母后的房间里清静一会而已。",
            "\t[勇士,hero]\b[up,null]......好。",
            "\t[公主,princess]\b[up,null]知道吗？以前负责抓捕我的护卫队可不像你这么绅士，我若是抵抗，他们甚至会用武力胁迫我就范。",
            "\t[公主,princess]\b[up,null]你跟他们很不一样。",
            "\t[勇士,hero]\b[up,null]......",
            "\t[勇士,hero]\b[up,null]公主大人，一直以来都辛苦你了。",
            "\t[公主,princess]\b[up,null]谢谢你，这么多年以来，你是除了母后以外第一个温柔待我的人。",
            "\t[公主,princess]\b[up,null]作为对你的答谢......嗯，我的一枚香吻怎么样？嘻嘻，脸比之前更红了~",
            "\t[公主,princess]\b[up,null]开个玩笑开个玩笑，我才没你想的那么轻浮。",
            {
                "type": "move",
                "loc": [
                    6,
            ...
            "\t[公主,princess]\b[up,null]这首曲子，是我母亲临终之前教会我的。",
            {
                "type": "setBlock",
                "number": "N1630",
                "loc": [
            ...
            "\t[公主,princess]\b[up,null]这是我第一次弹给别人听，怎么样？虽然礼乐科我总是拿低分......不过，一旦我认真起来用心演奏这首曲子，还是能勉强入耳的吧？",
            "\t[公主,princess]\b[up,null]愣着干什么？呆子，还不搬个小板凳过来认真听，还有啊，该鼓掌的时候要鼓掌，不然我饶不了你！",
            "\t[勇士,hero]\b[up,null]哦......哦！",
            {
                "type": "moveHero",
                "steps": [
                    "left:3",
            ...
            "\t[勇士,hero]\b[up,null]一个声部的曲调自始至终追逐着另一声部，好奇特的曲子。",
            "\t[公主,princess]\b[up,null]你以前从没听过这种奏法对吧？哼哼，这种名为卡农的谱曲风格可是我母后的独创哦。",
            "\t[勇士,hero]\b[up,null]这首曲子叫什么名字？",
            {
                "type": "setCurtain",
                "color": [
                    0,
            ...
            "\t[勇士,hero]......",
            "\t[勇士,hero]......（这个一直在我脑海里回响的旋律，原来叫做华音吗？）",
            "\t[勇士,hero]......（我好像忘记了一个很重要的人。）",
            "\t[勇士,hero]......（不同于我忘记自己的身世，名字......以及来到这座塔的原因。）",
            "\t[勇士,hero]......（这些记忆似乎都只是因为事故而暂时性被隔断而已。）",
            "\t[勇士,hero]......（但是......有关那个人的记忆......却像是被永久性粉碎了一样。）",
            "\t[勇士,hero]......（刚才捡起那颗宝石的时候，我好像回想起了小部分，不过，当我试图再次去触摸这个禁域时。）",
            "\t[勇士,hero]......（我所感觉到的，只有头疼欲裂。）",
            "\t[勇士,hero]......别瞎想了，妖精还在等我，现在可没到发呆的时候。"
        ]
    },
    "afterOpenDoor": {},
    "autoEvent": {
